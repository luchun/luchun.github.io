function init() {
  "use strict";
  var e = document.querySelector("#wheel > svg"), t = document.querySelector(".mdl-gen__cdn .mdl-gen__cdn-link"), a = new MaterialCustomizer(e, t), r = document.querySelector("#download");
  r.addEventListener("click", function () {
    window.navigator.msSaveBlob && window.navigator.msSaveBlob(this.blob, "material.min.css")
  ...
  t.addEventListener("click", function () {
    ...
    -1 !== window.getSelection().toString().indexOf(".min.css") && ga("send", {
      hitType: "event",
      eventCategory: "customizer",
      eventAction: "copy",
      eventLabel: a.getSelectedPrimary() + "-" + a.getSelectedSecondary()
...
MaterialCustomizer = function () {
  ...
  return l.prototype.init_ = function () {
    ...
    var e = this.config, t = this.wheel.querySelector("g.wheel--maing");
    ...
    var a = this.generateFieldTemplate_(), r = "http://www.w3.org/2000/svg";
    e.colors.forEach(function (n, i) {
      for (var l = a.cloneNode(!0), o = 1; 2 >= o; o++) {
        var s = document.createElementNS(r, "g"), c = document.createElementNS(r, "text");
    ...
    var e = "http://www.w3.org/2000/svg", t = this.config, a = document.createElementNS(e, "g"), r = document.createElementNS(e, "g"), n = document.createElementNS(e, "polygon");
    n.setAttribute("points", [[t.ri * Math.sin(t.alphaRad + t.alphaIncr), -t.ri * Math.cos(t.alphaRad + t.alphaIncr)].join(","), [t.r * Math.sin(t.alphaRad + t.alphaIncr), -t.r * Math.cos(t.alphaRad + t.alphaIncr)].join(","), [0, -t.r].join(","), [0, -(t.ri + t.hd)].join(",")].join(" "));
    var i = document.createElementNS(e, "polygon");
    i.setAttribute("points", [[t.ri * Math.sin(t.alphaRad + t.alphaIncr), -t.ri * Math.cos(t.alphaRad + t.alphaIncr)].join(","), [(t.ri + t.hd) * Math.sin(t.alphaRad + t.alphaIncr), -(t.ri + t.hd) * Math.cos(t.alphaRad + t.alphaIncr)].join(","), [0, -(t.ri + t.hd)].join(","), [0, -t.ri].join(",")].join(" ")), r.appendChild(n), r.appendChild(i), r.setAttribute("class", "polygons"), a.appendChild(r);
    ...
    var a = e(e(t.target)), r = a.getAttribute("data-color"), n = this.getNumSelected();
    ...
    var e = this.getSelectedPrimary(), t = this.getSelectedSecondary();
    ...
    var a = this.wheel.querySelector('[data-color="' + t + '"]'), r = e(a);
    ...
    var a = this.getColor(e, "500"), r = this.getColor(e, "700"), n = this.getColor(t, "A200");
    ...
    var t = e.split(","), a = this.calculateChannel(parseInt(t[0])), r = this.calculateChannel(parseInt(t[1])), n = this.calculateChannel(parseInt(t[2]));
    return .2126 * a + .7152 * r + .0722 * n
  }, l.prototype.calculateContrast = function (e, t) {
    var a = this.calculateLuminance(e) + .05, r = this.calculateLuminance(t) + .05;
    return Math.max(a, r) / Math.min(a, r)
  }, l.prototype.calculateTextColor = function (e) {
    var t = 3.1, a = "255,255,255", r = "66,66,66", n = this.calculateContrast(e, a);
    if (n >= t)return a;
    ...
    var e = document.getElementById("main-stylesheet"), t = document.createElement("style");
    ...
    var t = document.getElementById("download"), a = new Blob([e], {type: "text/css"});
    this.blob = a;
